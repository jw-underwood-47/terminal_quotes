# Code
All code included in the project is licensed under the 
GNU Affero General Public License Version 3 (AGPLv3, included as `LICENSE`)

# Quotes
All quotations in `quotes.txt` are, to the best of my knowledge,
from works that are in the public domain in the United States.
